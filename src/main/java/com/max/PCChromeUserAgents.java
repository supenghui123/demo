...
public class PCChromeUserAgents {
	...
	static String[] userAgents={			
	        ...
	        "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.122 Safari/537.36",
	...
	public static String getAUserAgent(){
		int random=new Random().nextInt(userAgents.length);
		return userAgents[random];
	}
	
	public static String getMBUserAgent(){
		int random=new Random().nextInt(mbuserAgents.length);
		return mbuserAgents[5];
	}
